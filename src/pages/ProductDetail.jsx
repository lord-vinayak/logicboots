...
The AI system continuously learns and adapts to your home's layout, furniture placement, and cleaning preferences. It can identify high-traffic areas that require more frequent cleaning and adjust its schedule accordingly. The robots also integrate seamlessly with smart home systems, allowing for voice control and remote monitoring.`,
      features: [
    ...
    "ai-stethoscope": {
      ...
      description:
        "Our AI-powered stethoscope transforms traditional auscultation into a digital, intelligent diagnostic tool that provides real-time analysis and remote monitoring capabilities.",
...
The remote monitoring capabilities allow doctors to assess patients from anywhere, making it ideal for telemedicine, rural healthcare, and emergency situations. The device maintains patient privacy while providing comprehensive data for better clinical decision-making.`,
      features: [
    ...
    "nanobots-cancer": {
      ...
      description:
        "Our nanobots represent a breakthrough in cancer treatment, offering precise, targeted drug delivery that minimizes side effects while maximizing therapeutic effectiveness.",
...
The system can be programmed to deliver different types of treatments, from chemotherapy drugs to gene therapy agents, and can be monitored in real-time using advanced imaging techniques. This approach significantly reduces the side effects commonly associated with traditional cancer treatments.`,
      features: [
      ...
      specifications: [
        ...
        "Navigation: Magnetic guidance",
        "Detection: AI-powered recognition",
    ...
    placeholder: {
      ...
      description:
        "We are working on exciting new products that will further revolutionize healthcare and household automation.",
...
Stay tuned for announcements about our latest innovations. We're committed to pushing the boundaries of what's possible with AI-powered robotics.`,
      features: [
      ...
      specifications: [
        ...
        "Applications: Healthcare & Automation",
      ...
      <SectionWrapper className={`${data.bgColor}`}>
        <div className="max-w-6xl mx-auto">
          <motion.div
            ...
            <div
              className={`w-24 h-24 bg-gradient-to-br ${data.color} rounded-3xl flex items-center justify-center mx-auto mb-6 shadow-lg`}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {data.features.map((feature, index) => (
              <motion.div
                ...
                <div
                  className={`w-8 h-8 bg-gradient-to-br ${data.color} rounded-lg flex items-center justify-center flex-shrink-0`}>
                  <svg
            ...
            <div className="space-y-4">
              {data.benefits.map((benefit, index) => (
                <motion.div
                  ...
                  <div
                    className={`w-6 h-6 bg-gradient-to-br ${data.color} rounded-full flex items-center justify-center flex-shrink-0 mt-1`}>
                    <svg
